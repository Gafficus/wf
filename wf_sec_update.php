...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if ($valid) { // if valid user input update the database
			...
			$sql = "UPDATE wf_secondary  set name = ?, type = ?, damage = ? WHERE id = ?";
			$q = $pdo->prepare($sql);
  ...
  <body style="background-color: lightblue !important";>
    <div class="container">
      <div class="span10 offset1">
			...
			<form class="form-horizontal" action="wf_sec_update.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
