...
include 'src/header.php'; // html <head> section
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $q = $pdo->prepare($sql);
            $q->execute(array($fname, $charName, $email, $password_hash));
            Database::disconnect();
			...
			<h3>Create a Person</h3>
			 ...
			 <form class="form-horizontal" action="wf_per_create.php" method="post">
					  ...
					  <div class="control-group <?php echo !empty($charNameError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input required name="charName" type="text"  placeholder="Character Name" value="<?php echo !empty($charName)?$charName:'';?>">
                      ...
                      <div class="form-actions">
                          ...
                          <a class="btn btn-danger" href="wf_per_list.php">Back</a>
                        </div>
                    </form>
	</div>
